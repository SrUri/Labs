    ...
    return (
        <div className="animate__animated animate__fadeIn">
            <div className="d-flex justify-content-between align-items-center mb-4">
                <h2 className="fw-bold mb-0">Resumen del Negocio</h2>
                <span className="badge bg-light text-dark border p-2">Actualizado: {new Date().toLocaleDateString()}</span>
            </div>
                    ...
                    <div className="card border-0 shadow-sm h-100 bg-white" onClick={() => setActiveTab('categories')} style={{cursor: 'pointer'}}>
                        <div className="card-body p-4">
                            <div className="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <div className="text-muted small fw-bold text-uppercase">Categorías</div>
                    ...
                    <div className="card border-0 shadow-sm h-100 bg-white" onClick={() => setActiveTab('products')} style={{cursor: 'pointer'}}>
                        <div className="card-body p-4">
                            <div className="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <div className="text-muted small fw-bold text-uppercase">Productos</div>
                    ...
                    <div className="card border-0 shadow-sm h-100 bg-white" onClick={() => setActiveTab('orders')} style={{cursor: 'pointer'}}>
                        <div className="card-body p-4">
                            <div className="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <div className="text-muted small fw-bold text-uppercase">Comandas</div>
                ...
                <div className="col-lg-8">
                    <div className="card border-0 shadow-sm">
                        <div className="card-header bg-white border-0 py-3">
                            <h5 className="mb-0 fw-bold">Últimas Comandas Registradas</h5>
                        </div>
                                ...
                                <tbody>
                                    {stats.recent_orders.map(order => (
                                        <tr key={order.id}>
                                            ...
                                            <td><span className="badge bg-light text-dark">{order.units} uds</span></td>
                    ...
                    <div className="card border-0 shadow-sm bg-success text-white">
                        <div className="card-body p-4">
                            ...
                            <button className="btn btn-light w-100 mb-2 text-start fw-bold" onClick={() => setActiveTab('products')}>
                                <i className="bi bi-file-earmark-pdf me-2"></i> Exportar Productos
                            </button>
                            <hr className="bg-white" />
                            <p className="small mb-0 opacity-75">Soporte técnico activo: <br /><b>info@studiogenesis.es</b></p>
                        </div>
                    </div>
                </div>
            </div>
